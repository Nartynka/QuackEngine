...
namespace Quack
{
	...
	public:		
		...
		static void DrawAxes(glm::vec3 x, glm::vec3 y, glm::vec3 z, glm::vec3 start = glm::vec3(0.f));
		static void DrawPolygon(unsigned int lineCount, const glm::vec3* lineArray, glm::vec3 color = glm::vec3(0.f, 1.f, 0.f));
